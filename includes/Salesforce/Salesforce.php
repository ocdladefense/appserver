...
class Salesforce
{
   ...
   // private const MAX_LOGIN_ATTEMPTS = 3;
    ...
    public function deleteRecordFromSession($sObject, $sObjectId)
    {
        $authResult = $this->authorizeToSalesforce();
        if (!$authResult->isSuccess()) {
            throw new SalesforceAuthException("Not Authorized");
        }
        return $this->deleteRecord($sObject, $sObjectId, $_SESSION["salesforce_instance_url"], $_SESSION["salesforce_access_token"]);
    }

    public function deleteRecord($sObject, $sObjectId, $instance_url = null, $access_token = null)
    {
        //variable(s)//
        $apiVersion = "v50.0";
