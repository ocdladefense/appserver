<?php
	...
	$handlers = array("Handler","ApplicationFileHandler","HttpResponseHandler","JsonHandler","HtmlEmailHandler","HtmlDocumentHandler","JsonErrorHandler","HtmlStringHandler","HtmlErrorHandler");
